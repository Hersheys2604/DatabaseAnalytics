...
//For task 3e, the resort id of 11 was used instead of 10 as suggested on edstem post Ass2B FAQ.
...
db.town.find(
    {"resorts.company_name": "Tropical Heaven"}
);
...
db.town.updateOne(
    {"name": "Mount Isa, QLD", "location.latitude": -20.7256, "location.longitude": 139.4927},
    {"$push":{"resorts": {"id": 11, "name": "Amazing Resort", "address": "7 Amazing Avenue", "phone": "1234567891", "year_built": "2023", "company_name": "Australia Experience"}},
     "$inc": {"no_of_resorts": 1}}
);
